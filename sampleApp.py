...
st.set_page_config(page_title="Issue Reporter", page_icon="📝", layout="centered")
...
page = st.sidebar.radio(
    "Go to",
    ["Disaster Issue Reporting", "About"],
    index=0
)
...
# Pages
# -------------------------
if page == "Disaster Issue Reporting":
    ...
    st.title("About")
    st.write("This app lets users report disaster-related issues by category, province, district, and time.")
